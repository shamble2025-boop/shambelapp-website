    ...
    <article className="max-w-3xl mx-auto px-4 py-12 relative">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4 mb-8 pb-6 border-b border-gray-100 dark:border-gray-800">
        ...
        <ShareButtons url={shareUrl} title={shareTitle} />
           ...
           <div 
        className="prose dark:prose-invert max-w-none text-base sm:text-lg leading-relaxed text-gray-700 dark:text-gray-300 lang-block-en break-words [&_iframe]:w-full [&_iframe]:h-full [&_iframe]:aspect-video [&_iframe]:rounded-2xl [&_iframe]:overflow-hidden [&_iframe]:my-4"
        dangerouslySetInnerHTML={{ __html: article.content_en || '' }} 
      />
      <div 
        className="prose dark:prose-invert max-w-none text-base sm:text-lg leading-relaxed text-gray-700 dark:text-gray-300 lang-block-am break-words [&_iframe]:w-full [&_iframe]:h-full [&_iframe]:aspect-video [&_iframe]:rounded-2xl [&_iframe]:overflow-hidden [&_iframe]:my-4"
